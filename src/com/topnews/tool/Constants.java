...
public class Constants {
	...
	public static ArrayList<NewsEntity> getNewsList() {
		...
		for(int i =0 ; i < 10 ; i++){
			...
			if(i%2 == 1){
				String url1 = "http://i1.sinaimg.cn/dy/c/2014-05-05/U10856P1T1D30063386F21DT20140505134344.jpg";
				...
				news.setPicTwo(url2);
				news.setPicThr(url3);
				news.setSource_url("http://tech.sina.com.cn/zl/post/detail/t/2016-05-31/pid_8507594.htm");
				url_list.add(url1);
				url_list.add(url2);
				url_list.add(url3);
			}else{
